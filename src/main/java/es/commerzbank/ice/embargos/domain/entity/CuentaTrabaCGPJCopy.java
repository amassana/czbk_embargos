 ...
 */
@Entity
@Table(name="CUENTA_TRABA_CGPJ_COPY")
@NamedQuery(name="CuentaTrabaCGPJCopy.findAll", query="SELECT c FROM CuentaTrabaCGPJCopy c")
@EntityListeners(CuentaTrabaListener.class)
public class CuentaTrabaCGPJCopy implements Serializable {
